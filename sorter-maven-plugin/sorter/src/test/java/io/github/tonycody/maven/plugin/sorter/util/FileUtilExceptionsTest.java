...
class FileUtilExceptionsTest {
    ...
    void whenOldBackupFileCannotBeDeletedAnExceptionShouldBeThrown() {
        FileHelper fileUtil = createFileUtil();
    ...
    private void doNotAccessRealBackupFile(FileHelper fileUtil) {
    ...
    void whenSourceFileCannotBeCopiedAnExceptionShouldBeThrown() {
        ...
        assertThat(
                "Unexpected message",
                thrown.getMessage(),
                is(equalTo("Could not create backup file to filename: " + pomFileTemp.getAbsolutePath() + ".bak")));
    }
    ...
    void whenPomFileTimestampCannotBeRetrievedAnExceptionShouldBeThrown() {
        ...
        assertThat(
                "Unexpected message",
                thrown.getMessage(),
                is(equalTo("Could not retrieve the timestamp of the pom file: " + pomFileTemp.getAbsolutePath())));
    }
    ...
    void whenPomFileTimestampCannotBeSetAnExceptionShouldBeThrown() {
        ...
        assertThat(
                "Unexpected message",
                thrown.getMessage(),
                is(equalTo("Could not change timestamp of new pom file: " + pomFileTemp.getAbsolutePath())));
    }

    private FileHelper createFileUtil() {
        FileHelper originalFileUtil = new FileHelper();
