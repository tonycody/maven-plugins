...
class IgnoredSectionsStoreTest {
    ...
    void revertTokensInOrderShouldWork() {
        ...
        assertThat(
                replaced,
                is("abc<?sortpom ignore?>def1<?sortpom resume?>cbaabc<?SORTPOM Ignore?>def2<?sortPom reSUME?>cba"));
    }
    ...
    void revertTokensInRearrangedOrderShouldPlaceTextInRightOrder() {
        ...
        assertThat(
                replaced,
                is("abc<?SORTPOM Ignore?>def1<?sortPom reSUME?>cbaabc<?sortpom ignore?>def0<?sortpom resume?>cba"));
    }
