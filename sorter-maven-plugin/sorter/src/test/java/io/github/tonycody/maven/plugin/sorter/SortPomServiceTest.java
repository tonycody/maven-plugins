...
class SortPomServiceTest {
    private final Sorter service = new Sorter();
    ...
    void equalWithDifferentNewlineShouldFail() {
        ...
        assertThat(
                originalXmlStringSorted.getErrorMessage(), is("The line separator characters differ from sorted pom"));
    ...
    void equalWithDifferentLengthShouldFail() {
        ...
        assertThat(originalXmlStringSorted.isOrdered(), is(false));
        assertThat(
                originalXmlStringSorted.getErrorMessage(), is("The line 2 is not considered sorted, should be 'you'"));

        setOriginalAndSortedXml("hello\nyou", "hello");
        originalXmlStringSorted = service.isOriginalXmlStringSorted();
        assertThat(originalXmlStringSorted.isOrdered(), is(false));
        assertThat(
                originalXmlStringSorted.getErrorMessage(), is("The line 2 is not considered sorted, should be empty"));
    }
