...
class SortDependencyManagementTests {
    ...
    final void dependencyManagementShouldBeUnaffected() throws Exception {
        SortPomImplUtil.create()
                ...
                .lineSeparator("\n")
                .testFiles("/SortDepManagement_input_withBomDeps.xml", "/SortDepManagement_expected_withBomDeps.xml");
    }
    ...
    final void onlySortDependencyManagementShouldNotAffectNormalDependencies() throws Exception {
        SortPomImplUtil.create()
                ...
                .lineSeparator("\n")
                .testFiles(
                        "/SortDepManagement_input_withBomDeps.xml", "/SortDepManagement_expected_onlySortDepMan.xml");
    }
}
